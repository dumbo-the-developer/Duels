...
public class BettingGui extends AbstractGui<DuelsPlugin> {
    ...
    private class WaitTask implements Runnable {
        ...
        public void run() {
            ...
            DuelsPlugin.getSchedulerAdapter().runTask(sender, (Runnable) sender::closeInventory);
            DuelsPlugin.getSchedulerAdapter().runTask(target, (Runnable) target::closeInventory);
