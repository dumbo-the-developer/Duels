...
public class BettingGui extends AbstractGui {
    ...
    public BettingGui(final Player first, final Player second) {
        ...
        InventoryUtil.fillSpace(inventory, 13, 14, 5, ItemBuilder.of(Material.IRON_FENCE).name(" ").build());
        InventoryUtil.fillRange(inventory, 0, 3, ItemBuilder.of(Material.STAINED_GLASS_PANE, 1, (short) 1).name(" ").build());
        InventoryUtil.fillRange(inventory, 45, 48, ItemBuilder.of(Material.STAINED_GLASS_PANE, 1, (short) 1).name(" ").build());
        InventoryUtil.fillRange(inventory, 6, 9, ItemBuilder.of(Material.STAINED_GLASS_PANE, 1, (short) 11).name(" ").build());
        InventoryUtil.fillRange(inventory, 51, 54, ItemBuilder.of(Material.STAINED_GLASS_PANE, 1, (short) 11).name(" ").build());
