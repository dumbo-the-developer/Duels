...
public class ItemConfig {
    ...
    public static void loadConfig() {
        file = new File(DuelsPlugin.getInstance().getDataFolder(), "replay_items.yml");
    ...
    public static void loadData() {
        ...
        for (ItemConfigType type : ItemConfigType.values()) {
            ...
            if (!cfg.contains("items." + name)) continue;
            ...
            String matString = cfg.getString("items." + name + ".id");
            if (matString == null) continue;
            matString = matString.toUpperCase();
    ...
    public static ItemConfigOption getItem(ItemConfigType type) {
        if (items.isEmpty() || !items.containsKey(type)) {
            addDefaults();
        }
    ...
    public static ItemConfigType getByIdAndName(Material material, String name) {
        for (ItemConfigType type : items.keySet()) {
            ...
            if (option != null && option.getMaterial() == material && option.getName().equals(name)) return type;
        }
        return null;
    }
