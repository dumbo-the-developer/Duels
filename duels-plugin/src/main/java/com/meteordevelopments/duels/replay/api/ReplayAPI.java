...
import com.meteordevelopments.duels.replay.storage.IReplaySaver;
...
public class ReplayAPI {
	...
	public void stopReplay(String name, boolean save, boolean ignoreEmpty) {
		if (ReplayManagerImpl.activeReplays.containsKey(name)) {
			Replay replay = ReplayManagerImpl.activeReplays.get(name);
