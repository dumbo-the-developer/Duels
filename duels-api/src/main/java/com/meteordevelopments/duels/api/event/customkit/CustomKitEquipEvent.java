...
/**
 * Called when a player is equipped with a custom kit.
 */
public class CustomKitEquipEvent extends PlayerEvent implements Cancellable {
    ...
    public CustomKitEquipEvent(@NotNull final Player player, @NotNull final CustomKit kit) {
