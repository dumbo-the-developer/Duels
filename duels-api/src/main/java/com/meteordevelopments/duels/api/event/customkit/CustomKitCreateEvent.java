...
/**
 * Called when a player creates a new custom kit.
 */
public class CustomKitCreateEvent extends PlayerEvent implements Cancellable {
    ...
    public CustomKitCreateEvent(@NotNull final Player player, @NotNull final CustomKit kit) {
